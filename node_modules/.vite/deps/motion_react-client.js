import {
  require_jsx_runtime
} from "./chunk-YETI75YM.js";
import {
  require_react
} from "./chunk-WON4C33O.js";
import {
  __require,
  __toESM
...
function useSVGProps(props, visualState, _isStatic, Component2) {
  const visualProps = (0, import_react7.useMemo)(() => {
...
function useRender(Component2, props, ref, { latestValues }, isStatic, forwardMotionProps = false, isSVG) {
  ...
  const elementProps = Component2 !== import_react8.Fragment ? { ...filteredProps, ...visualProps, ref } : {};
  const { children } = props;
  const renderedChildren = (0, import_react8.useMemo)(() => isMotionValue(children) ? children.get() : children, [children]);
  return (0, import_react8.createElement)(Component2, {
    ...elementProps,
...
var makeUseVisualState = (config) => (props, isStatic) => {
  const context = (0, import_react11.useContext)(MotionContext);
...
function useMotionRef(visualState, visualElement, externalRef) {
  const externalRefContainer = (0, import_react12.useRef)(externalRef);
  (0, import_react12.useInsertionEffect)(() => {
    externalRefContainer.current = externalRef;
  });
  const refCleanup = (0, import_react12.useRef)(null);
  return (0, import_react12.useCallback)((instance) => {
    var _a;
    if (instance) {
...
function useVisualElement(Component2, visualState, props, createVisualElement, ProjectionNodeConstructor, isSVG) {
  var _a, _b;
  const { visualElement: parent } = (0, import_react15.useContext)(MotionContext);
  const lazyContext = (0, import_react15.useContext)(LazyContext);
  const presenceContext = (0, import_react15.useContext)(PresenceContext);
  const motionConfig = (0, import_react15.useContext)(MotionConfigContext);
  const reducedMotionConfig = motionConfig.reducedMotion;
  const skipAnimations = motionConfig.skipAnimations;
  const visualElementRef = (0, import_react15.useRef)(null);
  const hasMountedOnce = (0, import_react15.useRef)(false);
  ...
  const wantsHandoff = (0, import_react15.useRef)(Boolean(optimisedAppearId) && typeof window !== "undefined" && !((_a = window.MotionHandoffIsComplete) == null ? void 0 : _a.call(window, optimisedAppearId)) && ((_b = window.MotionHasOptimisedAnimation) == null ? void 0 : _b.call(window, optimisedAppearId)));
...
function createMotionComponent(Component2, { forwardMotionProps = false, type } = {}, preloadedFeatures, createVisualElement) {
  ...
  const ForwardRefMotionComponent = (0, import_react16.forwardRef)(MotionDOMComponent);
...
var createDomVisualElement = (Component2, options) => {
  ...
  return isSVG ? new SVGVisualElement(options) : new HTMLVisualElement(options, {
    allowProjection: Component2 !== import_react17.Fragment
  });
};
...
function usePresence(subscribe = true) {
  ...
  const safeToRemove = (0, import_react18.useCallback)(() => subscribe && onExitComplete && onExitComplete(id3), [id3, onExitComplete, subscribe]);
...
function createMotionComponentWithFeatures(Component2, options) {
  return createMotionComponent(Component2, options, featureBundle, createDomVisualElement);
}
...
//# sourceMappingURL=motion_react-client.js.map
